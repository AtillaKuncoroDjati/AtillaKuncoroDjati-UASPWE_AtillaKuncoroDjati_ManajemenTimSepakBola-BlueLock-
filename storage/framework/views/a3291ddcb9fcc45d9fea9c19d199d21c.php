...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container">
            <form action="<?php echo e(url(Auth::user()->role . '/player/add')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\ella3\Documents\UNIVERSITAS MERCU BUANA\SEMESTER 5\PWE\blue_lock\bluelock11\resources\views/addplayer.blade.php ENDPATH**/ ?>