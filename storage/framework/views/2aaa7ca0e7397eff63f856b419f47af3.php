...
<div class="main-content">
    ...
    <!-- Export Button -->
    <a href="<?php echo e(url(Auth::user()->role . '/report')); ?>" class="btn-export">Export to PDF</a>
    <a href="<?php echo e(url(Auth::user()->role . '/export')); ?>" class="btn-export" style="background-color: #27ae60;">Export to CSV</a>
</div>

</body>
</html>
<?php /**PATH C:\Users\ella3\Documents\UNIVERSITAS MERCU BUANA\SEMESTER 5\PWE\blue_lock\bluelock11\resources\views/laporan.blade.php ENDPATH**/ ?>